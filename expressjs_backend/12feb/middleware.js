...
app.use(express.json());//one type of middleware to parse json data in request body, it will convert json data into js object and attach it to req.body
app.use(express.static("public"));//static middleware to serve static files from public folder, if we have any html, css, js files in public folder then we can access them directly without creating any route for them
